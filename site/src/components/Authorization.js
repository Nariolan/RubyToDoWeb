...
export default class Authorization extends React.Component{
    ...
    sign_in(){
        ...
        .then(token => {
            ...
            swal(
                <div>
                    <h1>Wrong usename or password!</h1>        
                    <p>Please, repeat input.</p>
                </div>
            )
        });
    }
    ...
    display_authorization(){
        return(
            <div className='mb-3 authorizationWrap'>
                <div className='bg-warning text-white card-header authorizationHead'>
                    Authorization
                </div>
                <div className='authorizationBody'>
                    <div className='authorizationForm'>
                        ...
                        <button className='btn btn-light formButton' onClick={this.sign_in}>Sign In</button>
                    </div>
