...
export function sign_in(login, password){
    ...
    const token_url = 'https://Nariolan.pythonanywhere.com/api/token'
...
export function sign_up(login, password){
    ...
    const users_url = 'https://Nariolan.pythonanywhere.com/api/users/'
...
export function get_projects(user_token){
    const projects_url = 'https://Nariolan.pythonanywhere.com/api/projects/'
    const header = {'Authorization': 'Token ' + user_token}
